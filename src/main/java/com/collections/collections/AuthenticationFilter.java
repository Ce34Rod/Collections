...
import com.collections.collections.controllers.AuthenticationController;
...
public class AuthenticationFilter implements HandlerInterceptor {
    ...
    private static final List<String> whitelist = Arrays.asList("/", "/login", "/css", "/images", "/register", "/get");
